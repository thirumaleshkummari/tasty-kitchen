    ...
    return (
      <ul className="restaurants-list">
        {restaurantsList.map(eachRestaurant => (
          ...
          >
            <li className="restaurants-list-item" data-testid="restaurant-item">
      ...
      <div className="home-route">
        ...
        <div className="popular-restaurants-section">
          <div className="popular-restaurants-header">
            ...
            <div className="search-bar">
              ...
              <input
                ...
                id="search-input"
                aria-label="Search Your Favorite Restaurant"
              />
            </div>
          ...
          <div className="pagination-buttons-bar">
            ...
            <p data-testid="active-page-number" className="page-no">
              {activePage}
            </p>
            <button
